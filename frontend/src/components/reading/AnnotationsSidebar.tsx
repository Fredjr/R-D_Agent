...
import { XMarkIcon, PencilIcon, TrashIcon, ChatBubbleLeftIcon } from '@heroicons/react/24/outline';
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-blue-50">
        <div>
          ...
          <p className="text-xs text-gray-600 mt-0.5">
            {highlights.length} highlight{highlights.length !== 1 ? 's' : ''} • Page {currentPage}
          </p>
        </div>
        {onClose && (
          <button
        ...
        {highlights.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-xs text-gray-600 max-w-xs mx-auto">
              Enable highlight mode (pencil icon) and select text to create your first highlight
            </p>
          </div>
        ) : (
